...
new_data = data[labels.Class.isin(["KIRC", "LUAD",])]
new_labels = labels[labels.Class.isin(["KIRC", "LUAD"])]
#new_labels[new_labels.Class == "KIRC"] = 1
#new_labels[new_labels.Class == "LUAD"] = -1
